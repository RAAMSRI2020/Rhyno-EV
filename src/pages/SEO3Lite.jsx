    ...
    <div className="product-page">
      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-col lg:flex-row">
          <img src={vehicle} alt="SE03 Lite" className="w-full lg:w-1/2 h-auto object-cover rounded-lg shadow-lg" />
          <div className="lg:ml-8 mt-6 lg:mt-0 lg:w-1/2">
            <h1 className="text-3xl font-bold text-gray-800">Rhyno SE03 Lite</h1>
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="flex items-center text-gray-700">
                  ...
                  <span>Battery: 1.8 kWh</span>
                </div>
                <div className="flex items-center text-gray-700">
                  <FaTachometerAlt className="text-yellow-500 mr-3" />
                  <span>Max Range (@30km/h): 100 km</span>
                </div>
                <div className="flex items-center text-gray-700">
                ...
                <div className="flex items-center text-gray-700">
                  ...
                  <span>Charging Time: 3 hours (12A)</span>
                </div>
                <div className="flex items-center text-gray-700">
                ...
                <div className="flex items-center text-gray-700">
                  <FaTachometerAlt className="text-yellow-500 mr-3" />
                  <span>Max Speed: 50 km/hr</span>
                </div>
                <div className="flex items-center text-gray-700">
                  <FaTachometerAlt className="text-yellow-500 mr-3" />
                  <span>Max Range (@full speed): 70 km</span>
                </div>
                <div className="flex items-center text-gray-700">
                  <FaTachometerAlt className="text-yellow-500 mr-3" />
                  <span>Max Range (@45km/h): 90 km</span>
                </div>
                <div className="flex items-center text-gray-700">
                  <FaShieldAlt className="text-gray-600 mr-3" />
                  <span>Other Key Benefits: Fire-safe battery, Range prediction, Comfortable ride and safe</span>
                </div>
                <div className="flex items-center text-gray-700">
                  <FaBatteryFull className="text-green-500 mr-3" />
