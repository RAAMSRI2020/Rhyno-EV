...
import vehicle from '../images/vehicle.png'; // Adjust the path as necessary
    ...
    <div className="product-page">
      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-col lg:flex-row">
          <img src={vehicle} alt="SE03" className="w-full lg:w-1/2 h-auto object-cover rounded-lg shadow-lg" />
          <div className="lg:ml-8 mt-6 lg:mt-0 lg:w-1/2">
            <h1 className="text-3xl font-bold text-gray-800">Rhyno SE03</h1>
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div className="flex items-center text-gray-700">
                  <FaTachometerAlt className="text-yellow-500 mr-3" />
                  <span>Max Range (@full speed): 110 km</span>
                </div>
                <div className="flex items-center text-gray-700">
                  <FaTachometerAlt className="text-yellow-500 mr-3" />
