        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <a href="/" className="flex items-center py-4 px-2">
              ...
              <span className="font-semibold text-white-100 text-lg">MyCompany</span>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              <button className="py-4 px-2 text-grey-100 border-b-4 border-transparent hover:text-yellow-100 hover:border-white-100 transition duration-900">
                Products
              </button>
              <div className="absolute left-0 hidden group-hover:block bg-grey-300 shadow-lg mt-1 rounded w-40 text-center">
                ...
                <a href="/product3" className="block px-4 py-2 text-white-100 hover:bg-grey-200">Compare All</a>
              </div>
            </div>
        ...
        <div className="md:hidden">
          ...
          {isProductsOpen && (
            <div>
              ...
              <a href="/product3" className="block py-2 px-4 text-sm text-grey-100 hover:bg-grey-300">Compare All</a>
            </div>
          )}
